...
;
; Revision: r2 - 29 May 2026 - Part 39: kosh.com migration. String
;             references switched from
;                 LOADI   X0, #SPAWN_ENTRY_OFFSET + (label - kosh_entry)
;             to bare
;                 LOADI   X0, #label
;             because kosh.asm now assembles with .ORG $0200 and labels
;             resolve directly to their in-page addresses. Additionally,
;             the reboot handler's JMP24 Start was changed to
;             JMP24 RESET_VECTOR — `Start` is a kernel-internal label
;             not visible to standalone .com assemblies; RESET_VECTOR
;             (now defined in kos_defs.inc r42 as $FF0000) gives a
;             stable, published entry point for the same target.
