...
.do_peek:
                ...
                ; No args → usage line.
                MOVE    Y0, Y3
                LOADI   X0, #SPAWN_ENTRY_OFFSET + (msg_peek_usage - kosh_entry)
                TRAP    #TRAP_PUTS
                BRA     .repl_loop
...
.peek_have_args:
                ...
                MOVE    D0, D2
                CALL24  _KoshEmitByteHex        ; page 2 hex digits
                LOADI   D0, #':'
                CALL24  _KoshEmitByte
                MOVE    D0, D3
                CALL24  _KoshEmitWordHex        ; offset 4 hex digits
                LOADI   D0, #CH_SPACE
                CALL24  _KoshEmitByte
                CALL24  _KoshEmitByte           ; (D0 still SP)
                MOVE    D0, D1
                CALL24  _KoshEmitByteHex        ; byte 2 hex digits
                LOADI   D0, #CH_SPACE
                CALL24  _KoshEmitByte
                CALL24  _KoshEmitByte
                LOADI   D0, #$27                ; '
...
.do_dump:
                ...
                MOVE    Y0, Y3
                LOADI   X0, #SPAWN_ENTRY_OFFSET + (msg_dump_usage - kosh_entry)
                TRAP    #TRAP_PUTS
                BRA     .repl_loop
