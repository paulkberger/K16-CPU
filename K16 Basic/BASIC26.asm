; ============================================================================
; K16 BASIC v2.6 - .COM build for k/OS  (Saturday, 1 August 2026)
; ============================================================================
; v2.6: Part 60 - .COM header. The image now opens with the universal
...
;
;       No code change; the JMP16 MAIN at $0200 was already there and the
;       header simply follows it. Every internal reference is PC-relative
;       or assembler-resolved, so the 12-byte shift costs nothing. But the
;       loader now REFUSES a headerless image: v2.5 .COM files will not run
;       under a Part 60 kernel, and this image will not run under an older
;       one. Flag day, no grace period.
;
...
BANNER:     .TEXT   "K16 BASIC v2.6", $0A, 0
