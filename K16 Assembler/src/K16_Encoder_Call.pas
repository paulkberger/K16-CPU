...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // enables forms like 'CALL24 func+4' or 'CALL24 base+OFFS'.
  ...
  begin
    ...
    begin
      ...
      begin
        // Symbol target: CALL16 LABEL  (prepend '#' for expression support)
        TargetAddress := SymbolResolver('#' + Instr.Operands[0], Instr.LineNumber);
      end;
    end
    else
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // Offset = Target - (PC + 4)
        // Prepend '#' for expression support (e.g. 'CALLR func+4')
        TargetAddress := SymbolResolver('#' + Instr.Operands[0], Instr.LineNumber);
