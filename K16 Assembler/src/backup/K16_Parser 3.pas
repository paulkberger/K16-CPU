    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AddError(Format('%s does not support [XY+offset] — only [XY]. ' +
                          'Use LOADD/LOADB into a register first',
                          [Result.Mnemonic]))
        else
    ...
    begin
      ...
      begin
        ...
        if Result.MemoryRef.HasOffset or Result.MemoryRef.HasRegisterOffset then
          AddError('CMP does not support [XY+offset] — only [XY]. ' +
                   'Use LOADD/LOADB into a register first')
        else
...
begin
  ...
  // Remove old amImm5S and amImm8S validations - these modes no longer exist
