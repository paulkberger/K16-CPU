...
var
  ...
  DebugLogProc  : procedure(const s: string) = nil;
...
begin
  ...
  if Assigned(DebugLogProc) then
    DebugLogProc(Format('LOADP  Yn=%d Y[n]=$%2.2X Imm=$%4.4X addr=$%6.6X v=$%4.4X',
      [Yn, CPU.Y[Yn], D.Imm16, addr, v]));
end;
