...
begin
  ...
  begin
    ...
    begin
      ...
      LabelStatus.Caption := Format('bmp=%dx%d rh=%d', [FVideoBmp.Width, FVideoBmp.Height, FVideoRH]);
      pbVideo.Canvas.StretchDraw(Rect(FVideoRX, FVideoRY, FVideoRX+FVideoRW, FVideoRY+FVideoRH), FVideoBmp);
    end;
  end;
...
begin
  ...
  pb.Canvas.FillRect(Rect(0,0,W,H));
  { FVideoBmp is pre-built by UpdateVideoBmp — just draw it }
