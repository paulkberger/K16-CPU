...
begin
  ...
  StringGridMemory.ColWidths[1] := 64;    { word 1 }
  StringGridMemory.ColWidths[2] := 64;    { word 2 }
  StringGridMemory.ColWidths[3] := 64;    { etc. }
  StringGridMemory.ColWidths[4] := 64;
  StringGridMemory.ColWidths[5] := 64;
  StringGridMemory.ColWidths[6] := 64;
  StringGridMemory.ColWidths[7] := 64;
  StringGridMemory.ColWidths[8] := 64;
