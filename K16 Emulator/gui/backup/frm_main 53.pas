...
begin
  ...
  rx    := (W - rw) div 2;
  ry    := (H - rh) div 2;
  { Scale via intermediate bitmap — StretchDraw on ScanLine bitmaps unreliable in LCL }
  FScaledBmp.SetSize(rw, rh);
  FScaledBmp.Canvas.StretchDraw(Rect(0, 0, rw, rh), FVideoBmp);
  pb.Canvas.Draw(rx, ry, FScaledBmp);
end;
