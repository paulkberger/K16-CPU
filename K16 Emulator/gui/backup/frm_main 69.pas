...
{ Creates a fresh TBitmap each call — no GDI DDB cache carryover between frames.
  Draws directly to the panel DC via GetDC/BitBlt/ReleaseDC (no WM_PAINT cycle).
  Stores result in FVideoBmp so PbVideoPaint can redraw on window-uncover. }
const
  OUT_W = 1024;
  OUT_H = 768;
var
