...
begin
  ...
  TimerRefresh.Interval := 33;  { ~30 Hz video refresh }
  EditBP.Text         := 'FF0000';
  EditMhz.Text        := '10';
...
begin
  ...
  destDC := LCLIntf.GetDC(pbVideo.Handle);
  LCLIntf.BitBlt(destDC, 0, 0, OUT_W, OUT_H,
                 FVideoBmp.Canvas.Handle, 0, 0, $00CC0020);
  LCLIntf.ReleaseDC(pbVideo.Handle, destDC);
end;
