...
begin
  ...
  if FVideoMode > 0 then pbVideo.Invalidate;
  MemoTerminal.Lines.Add(Format('HALT VM=%d A00000=$%2.2X A00280=$%2.2X',
    [FVideoMode, Mem[$A00000], Mem[$A00280]]));
...
begin
  DrainTermQueue;
  UpdateSpeedLabel;
  if (FVideoMode > 0) and (FCPUThread <> nil) and not CPU.Halted then pbVideo.Invalidate;
