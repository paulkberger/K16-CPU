...
begin
  ...
  RefreshRegs;
  RefreshDisasm;
  MemoTerminal.Lines.Add(Format('HALT: FVideoMode=%d Mem[$A00000]=$%2.2X',
    [FVideoMode, Mem[FB_BASE]]));
  if FVideoMode > 0 then pbVideo.Repaint;
...
{ Video                                                         }
{ ============================================================ }
procedure TfrmMain.VideoRepaintProc;
begin
  if FVideoMode > 0 then pbVideo.Repaint;
end;
